...
const Navbar = () => {
  ...
  return (
    ...
    ${isOpen ? 'h-auto bg-[rgba(216,216,216,0.6)] dark:bg-[rgba(0,0,0,0.5)] shadow-lg rounded-b-2xl md:rounded-b-3xl lg:rounded-b-none' : 'h-[4.5rem] bg-[rgba(241,241,241,0.3)] dark:bg-[rgba(26,26,26,0.5)] shadow-none rounded-b-none'}
    `}>
      <div className='flex lg:block justify-between items-center z-[70]'>
        <a href="" className='md:w-60 s:w-48 w-44 block'><img src="./src/assets/icon3.png" alt="Work Projects" className='dark:invert' /></a>
        <img ref={navBtnRef} src="./src/assets/menu.svg" alt="Menu" onClick={e => menuClick(e)} className='lg:hidden md:w-11 w-9 pr-1 self-center transition-all duration-700 ease-in-out opacity-80 dark:invert' />
      </div>
      <ul className='flex lg:flex-row flex-col lg:p-0 pt-6 pl-6 gap-[0.6vw] lg:items-center'>
        <a href="#home" className=''>
          <li className='lg:w-24 sm:w-1/4 cursor-pointer lg:text-center border-b-[1.6px] border-[rgba(43,43,43,0)] hover:border-[rgba(60,60,60,0.8)] hover:tracking-widest active:font-semibold transition-all duration-200 ease-[cubic-bezier(0.39, 0.58, 0.57, 1)] lg:text-base lg:font-descriptions lg:font-normal leading-tight font-bold md:text-[2.85rem] text-[2.5rem] font-titles'>Home</li>
        </a>
      ...
      <div className="lg:hidden flex border-t-[1px] border-[#2b2b2b] dark:border-[#e1e1e1] dark:border-t-[0.5px] py-2 mt-[10%] justify-between">
