...
const Navbar = () => {
  ...
  return (
    ...
    `}>
      ...
      <ul className='lg:flex lg:p-0 sm:pt-6 sm:pl-6 sm:block gap-[0.6vw] items-center'>
        <a href="#home" className=''>
          <li className='lg:w-24 sm:w-1/4 cursor-pointer lg:text-center border-b-[1.6px] border-[rgba(43,43,43,0)] hover:border-[rgba(43,43,43,0.8)] hover:tracking-widest active:font-semibold transition-all duration-200 ease-[cubic-bezier(0.39, 0.58, 0.57, 1)] lg:text-base lg:font-descriptions lg:font-normal sm:leading-tight sm:font-bold sm:text-[2.85rem] sm:font-titles'>Home</li>
        </a>
        <a href='#about-me' className=''>
          <li className='lg:w-24 sm:w-1/4 cursor-pointer lg:text-center border-b-[1.6px] border-[rgba(43,43,43,0)] hover:border-[rgba(43,43,43,0.8)] hover:tracking-widest active:font-semibold transition-all duration-200 ease-[cubic-bezier(0.39, 0.58, 0.57, 1)] lg:text-base lg:font-descriptions lg:font-normal sm:leading-tight sm:font-bold sm:text-[2.85rem] sm:font-titles'>About Me</li>
        </a>
        <a href="#projects" className=''>
          <li className='lg:w-24 sm:w-1/4 cursor-pointer lg:text-center border-b-[1.6px] border-[rgba(43,43,43,0)] hover:border-[rgba(43,43,43,0.8)] hover:tracking-widest active:font-semibold transition-all duration-200 ease-[cubic-bezier(0.39, 0.58, 0.57, 1)] lg:text-base lg:font-descriptions lg:font-normal sm:leading-tight sm:font-bold sm:text-[2.85rem] sm:font-titles'>Projects</li>
        </a>
        <a href="#resume" className=''>
          <li className='lg:w-24 sm:w-1/4 cursor-pointer lg:text-center border-b-[1.6px] border-[rgba(43,43,43,0)] hover:border-[rgba(43,43,43,0.8)] hover:tracking-widest active:font-semibold transition-all duration-200 ease-[cubic-bezier(0.39, 0.58, 0.57, 1)] lg:text-base lg:font-descriptions lg:font-normal sm:leading-tight sm:font-bold sm:text-[2.85rem] sm:font-titles'>Résumé</li>
        </a>
      </ul>
      <a href="#contacts" className='block lg:inline lg:text-center lg:m-0 sm:ml-6 self-center lg:w-24 sm:w-1/4 cursor-pointer list-none border-b-[1.6px] border-[rgba(43,43,43,0)] hover:border-[rgba(43,43,43,0.8)] hover:tracking-widest active:font-semibold transition-all lg:text-base lg:font-descriptions lg:font-normal sm:leading-tight sm:font-bold sm:text-[2.85rem] sm:font-titles'>
        Contacts
      </a>
    </nav>
  )
